    ...
    <>
      ...
      <section style={{ borderTop: '1px solid var(--line)' }}>
        <div className="media-strip">
          ...
          <div className="plate">
            <span className="tag">Whiteboard</span>
            <span className="corner">A.002</span>
            <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&amp;q=80" alt="Whiteboard with sticky notes" />
          </div>
          <div className="plate">
            <span className="tag">Crit night</span>
            <span className="corner">A.003</span>
            <img src="https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=1200&amp;q=80" alt="Studio meeting" />
          </div>
        </div>
      </section>
          ...
          <div className="team-grid sr-stag">
            ...
            <div className="team-card">
              <div className="avatar" style={{ position: 'relative' }}>
                <div className="placeholder" style={{ inset: 0, position: 'absolute' }}>
                  <div className="ph-ticks">
                    <span>SK</span>
                    <span>4:5</span>
                  </div>
                  <div className="ph-inner">[ Portrait ]</div>
                </div>
              </div>
